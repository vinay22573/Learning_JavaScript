...
// console.log(balance);
// console.log(`${typeof (balance.toString())} Type with value ${balance.toString()}`);
...
// console.log(Math.random()*10);(again due to 0 our scaling might not work as expected)
// console.log((Math.random()*10)+1);(1 to 10)
// console.log((Math.floor(Math.random()*10))+1);//(1 to 10)
// Understanding how to use min, max with random
// const min = 10;
// const max = 20;
